...
//      }
    ...
    //if (num_properties >= 1) {
      ...
      Process proc1 = null;
      try {
        //proc1 = Runtime.getRuntime().exec(new String[]{"/home/seem/research/tools/prism-4.5-linux64/bin/prism", model_file, proerties_file, "-prop", "1"});

          proc1 = Runtime.getRuntime().exec(new String[]{"/home/seem/research/tools/prism-4.5-linux64/bin/prism", model_file, proerties_file});
...
//      }
    ...
    if(num_properties == 2) {
      ...
      Process proc2 = null;
      try {
        proc2 = Runtime.getRuntime().exec(new String[]{"/home/seem/research/tools/prism-4.5-linux64/bin/prism", model_file, proerties_file, "-prop", "2"});
